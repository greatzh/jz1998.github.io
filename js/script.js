...
(function($) {
    ...
    var wW, wH, half_wW, half_wH, aspect_ratio, canvas, ctx_t, bgCanvas, bgctx, particles = [],
        img, cW, cH, create_t_left, create_t_top, int_draw_t, wW_ratio, wH_ratio, analyser, source, gainNode, maxMagnitude, c, ctx;
    ...
    $(document).on({ mousedown: function() { $(this).addClass("grab") }, mouseup: function() { $(this).removeClass("grab") } }, ".circle_control");
